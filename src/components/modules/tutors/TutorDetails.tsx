...
const TutorDetails = async ({tutor}:{tutor:TTutor}) => {
  return (
    <div className=" py-8">
        ...
        <div className="bg-gradient-to-l from-primary/40 to-secondary/50 backdrop-blur px-6 py-8 sm:p-10">
          <div className="flex flex-col md:flex-row items-center">
            <div className="relative h-32 w-32 rounded-full overflow-hidden border-4 border-primary mb-4 md:mb-0 md:mr-6">
              <Image 
                src={tutor?.profileImage !== undefined ? tutor?.profileImage as string : defaultProfile}
                alt={tutor?.name} 
                fill 
            ...
            <div className="text-center md:text-left">
              ...
              <div className="flex items-center justify-center md:justify-start mt-2">
                <div className="flex items-center">
                  ...
                  <span className="text-white ml-1">{tutor?.rating?.ratingValue}</span>
                </div>
                <span className="text-white mx-3">|</span>
                <span className="text-white font-semibold">${tutor?.hourlyRate}/hr</span>
              </div>
            </div>
